defmodule ReactorApWeb.ProductLive.FormComponent do
  ...
  defp save_product(socket, :edit, params) do
    product_params = params_with_image(params, socket)
  ...
  defp params_with_image(params, socket) do
    path =
      socket
