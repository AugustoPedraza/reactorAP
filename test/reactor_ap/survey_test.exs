defmodule ReactorAp.SurveyTest do
  use ReactorAp.DataCase

  alias ReactorAp.Survey
  alias Survey.{Demographic, Rating}

  import ReactorAp.{AccountsFixtures, CatalogFixtures, SurveyFixtures}
  ...
  describe "demographics" do
    ...
    test "create_demographic/1 with valid data creates a demographic" do
      valid_attrs = %{gender: "other", year_of_birth: 1999, user_id: user_fixture().id}
